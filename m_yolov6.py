#
# This script was derived from yolov6/core/inferer.py
#
# The main reason was to avoid rebuilding the model 
# each time we run inference
#
# In the yolov6/core/inferer.py, we need to pass the
# image's source to the constructor to create the model
#
# Here, we modified it so we only need to pass the
# image's source when we run infer( ) function
#
